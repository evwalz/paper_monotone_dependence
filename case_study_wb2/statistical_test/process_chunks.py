...
import pickle
import sys
from helper_stats import cma_test_new_fast_clean
from statistical_test.config import CHUNK_DIR, RESULTS_DIR
...
def process_chunk(chunk_idx, chunk_dir=CHUNK_DIR, output_dir=RESULTS_DIR):
    ...
    for i in range(start_idx, end_idx):
        ...
        try:
            cmas, pvals, ci, global_p, variance = cma_test_new_fast_clean(obs_series, x0)
